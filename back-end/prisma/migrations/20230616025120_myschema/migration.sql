...
-- AlterTable
ALTER TABLE "Friendship" ALTER COLUMN "SenderId" SET DATA TYPE BIGINT,
ALTER COLUMN "ReceiverId" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "Game" ALTER COLUMN "PlayerId1" SET DATA TYPE BIGINT,
ALTER COLUMN "PlayerId2" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "Membership" ALTER COLUMN "UserId" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "Message" ALTER COLUMN "UserId" SET DATA TYPE BIGINT;

-- AlterTable
ALTER TABLE "Notification" ALTER COLUMN "UserId" SET DATA TYPE BIGINT;
